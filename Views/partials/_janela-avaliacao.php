    ...
    <div class="bg-slate-800 p-6 rounded-lg shadow-lg max-w-md w-full text-white relative">
        ...
        <div class="grid grid-cols-3 gap-4 items-center mb-6">
            ...
            <div class="col-span-2 space-y-1">
                ...
                <p class="text-sm text-slate-400">Nota atual: <span class="font-medium">8.5</span></p>

                <!-- Campo de nota com estrelas -->
                <div>
        ...
        <!-- Formulário -->
        <form action="/salvar-avaliacao" method="POST" class="space-y-4">
            <!-- Campo de comentário -->
            <div>
                <div class="relative">
                    <textarea
