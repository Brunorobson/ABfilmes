<div class="max-w-xl mx-auto p-8">
    <h1 class="text-slate-400 font-rammetto px-4 py-2 text-xl">Acesse sua conta</h1>
    ...
    <form class="p-4 space-y-4" method="POST">
        ...
        <i class="ph-light ph-envelope text-slate-400 absolute top-1/2 left-3 transform -translate-y-1/2 text-lg"></i>
                <input
                    ...
                    name="email"
                    placeholder="E-mail"
                    class="pl-10 border border-slate-800 rounded-md bg-slate-950 text-sm text-slate-400 focus:outline-none px-2 py-2 w-full" />
            </div>
        </div>
